    ...
    <div className="min-h-screen">
      ...
      <section className="bg-white dark:bg-gray-900 py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-accent dark:text-accent-light mb-16">
            Core Survey Services
          </h2>
          <div className="grid gap-8 md:grid-cols-3">
            {/* Aeromagnetics */}
            <div className="bg-white dark:bg-gray-800 p-8 border border-gray-200 dark:border-gray-700 rounded-lg card-hover shadow-sm">
              <div className="text-accent dark:text-accent-light mb-4">
                <MagnifyingGlassIcon className="w-12 h-12" />
              </div>
              <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Aeromagnetics</h3>
              ...
              <Link href="/services#aeromagnetics" className="text-accent dark:text-accent-light hover:text-accent-light font-medium mt-4 inline-block">
                Learn more →
              </Link>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 border border-gray-200 dark:border-gray-700 rounded-lg card-hover shadow-sm">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">LiDAR Surveys</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <Link href="/services#lidar" className="text-accent dark:text-accent-light hover:text-accent-light font-medium mt-4 inline-block">
                Learn more →
              </Link>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 border border-gray-200 dark:border-gray-700 rounded-lg card-hover shadow-sm">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Gravity & Seepfinder</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              <Link href="/services#gravity-seepfinder" className="text-accent dark:text-accent-light hover:text-accent-light font-medium mt-4 inline-block">
                Learn more →
              </Link>
            </div>
          </div>
      ...
      <section className="bg-gray-50 dark:bg-gray-800 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/about" 
                  className="border border-accent dark:border-accent-light text-accent dark:text-accent-light hover:bg-accent hover:text-white dark:hover:bg-accent-light font-semibold py-3 px-6 rounded-lg transition-colors duration-200">
              Our Experience
            </Link>
          </div>
        </div>
