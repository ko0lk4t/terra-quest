        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:hello@terraquest.com" className="text-gray-300 hover:text-accent transition-colors" aria-label="Email">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/services#aeromagnetics" className="block text-gray-300 hover:text-accent transition-colors">
                Aeromagnetics
              </Link>
              <Link href="/services#lidar" className="block text-gray-300 hover:text-accent transition-colors">
                LiDAR Surveys
              </Link>
              <Link href="/services#gravity-seepfinder" className="block text-gray-300 hover:text-accent transition-colors">
                Gravity & Seepfinder
              </Link>
            </div>
          </div>
